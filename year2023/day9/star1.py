...
def getExtrapolation(valueHistory):
    ...
    last_numbers_of_sequences_of_differences = [sequence_of_differences[-1] for sequence_of_differences in sequences_of_differences]

    extrapolation = valueHistory[-1] + sum(last_numbers_of_sequences_of_differences)
